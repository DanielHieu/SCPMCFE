    ...
    >
      <div className="container mx-auto px-4 md:px-8 flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center space-x-8">
          ...
          <Link 
            href="/login" 
            className="bg-gradient-to-r from-emerald-500 to-teal-600 hover:from-emerald-600 hover:to-teal-700 text-white px-5 py-2.5 rounded-lg font-medium transition shadow-md"
          >
            Đăng nhập
          </Link>
        </nav>
      ...
      {isMobileMenuOpen && (
        <div className="md:hidden bg-white py-4 px-4 shadow-lg mt-2 border-t border-gray-100">
          <div className="flex flex-col space-y-4">
            ...
            <Link 
              href="/login" 
              className="bg-gradient-to-r from-emerald-500 to-teal-600 hover:from-emerald-600 hover:to-teal-700 text-white px-5 py-2.5 rounded-lg font-medium transition shadow-md text-center"
              onClick={() => setIsMobileMenuOpen(false)}
            >
              Đăng nhập
            </Link>
